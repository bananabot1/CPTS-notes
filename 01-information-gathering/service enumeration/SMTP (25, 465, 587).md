...
- SMTP provides no reliable delivery confirmation and does not authenticate senders by default. This makes open relay misconfigurations a direct path to mail spoofing and spam abuse.
