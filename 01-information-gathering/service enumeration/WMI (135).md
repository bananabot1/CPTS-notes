**Overview:**
Windows Management Instrumentation (`WMI`) is Microsoft's implementation of the Common Information Model (`CIM`), core functionality of the standardized Web-Based Enterprise Management (`WBEM`) for the Windows platform. 
...
connect to the WMI service using wmiexec from the impacke